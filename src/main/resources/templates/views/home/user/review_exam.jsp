			...
			<div class="test">
				<form action="" method="post">
					<div class="test_title">
						<p class="test_time">
							<img style="float:left;margin-top:15px;margin-left:10px;" src="../../resources/home/exam/images/time.png" width="16px"><b class="alt-1">${exam.availableTime }</b>
						</p>
				...
				<div class="rt_nr1">
					<div class="rt_nr1_title">
						...
						<p class="test_time">
							...
							<b class="alt-1">${exam.availableTime }</b>
						</p>
					</div>
					<c:if test="${exam.singleQuestionNum !=0 }">
